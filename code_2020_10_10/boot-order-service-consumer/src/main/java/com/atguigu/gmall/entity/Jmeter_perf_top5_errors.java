...
public class Jmeter_perf_top5_errors {
    ...
    public Jmeter_perf_top5_errors(){}

    public Jmeter_perf_top5_errors(String scriptname, String threads, String runtime, List<String> list, String url, String jplpath, String indexpath, int states) {
        this.scriptname = scriptname;
        this.threads = threads;
        this.runtime = runtime;
