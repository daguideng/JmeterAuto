...
public class IDCardGenerator {
     ...
     * 获取指定身份证号的性别
     *
     * @param IDCard MALE：男；FEMALE：女
     * @return
     */
    public static String generateSex(String IDCard) {
        boolean sex = true;
        int numLength = IDCard.length() - 1;
        String lastTwoNum = IDCard.substring(numLength - 1, numLength);
        int sex1 = Integer.valueOf(lastTwoNum).intValue() % 2;
        String male = "MALE";
        if (sex1 != 1) {
            male = "FEMALE";
        }
    ...
    private static int randomAreaCode() {
        ...
        int code;
        for (code = 0; i < index && it.hasNext(); code = it.next().intValue()) {
            ++i;
        }
    ...
    private static String randomBirthday() {
        ...
        birthday.set(1, (int) (Math.random() * 35.0D) + 1960);
