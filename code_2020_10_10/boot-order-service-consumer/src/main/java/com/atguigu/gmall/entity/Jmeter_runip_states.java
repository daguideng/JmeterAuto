...
@Component("consumer_jmeter_runip_states")
public class Jmeter_runip_states extends Jmeter_agentip_states {
    private Integer id;
    ...
    public Jmeter_runip_states(Integer id, String ipaddress, String states, String type, String time, String runusername, Integer runstate) {
        this.id = id;
    ...
    public Jmeter_runip_states(Integer id, String type) {
        this.id = id;
        this.type = type;
    }
}