...
public class Perf_config {
    ...
    public Perf_config(String threads, String runtime, String delaytime, String ifretry, String ifoutinterval, String ifcustomlistener, String ifrecordlogjtl, String ifrecordlogjmeter, String ifbetweenvalue, String threadname, String status) {
