...
public class Interface_history_report {
    private Integer id;
    ...
    public Interface_history_report(){}


    // 使用Map<String, Object>的更健壮构造函数
    public Interface_history_report(Map<String, Object> data) {
        ...
        this.state = getInteger(data, "state");
    }
