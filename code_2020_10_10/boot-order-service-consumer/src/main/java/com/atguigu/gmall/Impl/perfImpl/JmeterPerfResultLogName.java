...
@Scope("prototype")
@Component
public class JmeterPerfResultLogName implements Serializable{
    ...
    public JmeterPerfResultLogName(String jmeterJmx, String jmeterLog, String jmeterJtl, String report) {
    ...
    public JmeterPerfResultLogName(String jmeterLog, String jmeterJtl, String report) {
        this.jmeterlog = jmeterLog;
        this.jmeterjtl = jmeterJtl;
        this.report = report;
    }

    public JmeterPerfResultLogName(){}
