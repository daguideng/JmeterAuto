 ...
 */
public class PerfConfigModel implements Serializable {
    ...
    public PerfConfigModel(String vuser, String runtime, String sleeptime, String delaytime, String retry, String retryVal, String output, String outputInterval, String customListener, String jtlListener, String logListener, String betweenValue, String threadname, String status) {
        this.vuser = vuser;
        this.runtime = runtime;
        this.sleeptime = sleeptime;
        this.delaytime = delaytime;
    ...
    public PerfConfigModel(String vuser, String runtime, String sleeptime, String delaytime, String retry, String retryVal, String output, String outputInterval, String customListener, String jtlListener, String logListener, String betweenValue) {
        this.vuser = vuser;
        this.runtime = runtime;
        this.sleeptime = sleeptime;
        this.delaytime = delaytime;
