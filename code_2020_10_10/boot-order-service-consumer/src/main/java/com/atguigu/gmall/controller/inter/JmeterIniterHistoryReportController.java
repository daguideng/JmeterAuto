...
public class JmeterIniterHistoryReportController {
    ...
    //@ApiOperation(value = "inter：列表展示性能测试报告")
    ...
    //    log.info("输入的查询条件filter:{}", filter);
        ...
        InterHistoryReortQuery query = new InterHistoryReortQuery();
        ...
        result.setData(this.jmeterInterormhistoryreportServer.list(query));
        return result;
    }
